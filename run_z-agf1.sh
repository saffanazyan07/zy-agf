...
sudo ./d-cu --rfsim -O ../../../targets/PROJECTS/GENERIC-NR-5GC/CONF/z-agf1.gnb-du.sa.band78.106prb.rfsim.pci0.conf \
...
sudo ./proxy-ue -C 3450720000 -r 106 --numerology 1 --ssb 516 -O ../../../targets/PROJECTS/GENERIC-NR-5GC/CONF/proxy-ue1.conf --rfsim \
